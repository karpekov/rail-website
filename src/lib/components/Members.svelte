                ...
                <div class="flex-none w-[140px] sm:w-[160px] flex flex-col items-center space-y-2 p-2 rounded-lg bg-surface-100-800-token member-card"
                    ...
                    <div
                        ...
                        <div class="flex gap-1.5 sm:gap-2 mt-2">
                            {#if member.website}
                                <a href={member.website} target="_blank" rel="noopener noreferrer" class="text-sm social-icon" title="Personal Website">
                            ...
                            {/if}
                            {#if member.linkedin}
                                <a href={member.linkedin} target="_blank" rel="noopener noreferrer" class="text-sm social-icon" title="LinkedIn">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            {/if}
                            {#if member.twitter}
                                <a href={member.twitter} target="_blank" rel="noopener noreferrer" class="text-sm social-icon" title="X (Twitter)">
                                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
